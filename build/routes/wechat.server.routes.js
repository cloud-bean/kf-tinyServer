...
//   }
// ));
router.use('/', wechat(wechatConfig.token).text(wechatController.handleText).voice(wechatController.handleVoice).image(wechatController.handleImage).event(wechatController.handleEvent).middlewarify(), (req, res) => {
    res.reply('');
});
...
//   // OpenID: 'oPKu7jgOibOA-De4u8J2RuNKpZRw' }
// })
//# sourceMappingURL=wechat.server.routes.js.map